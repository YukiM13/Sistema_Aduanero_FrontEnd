...
const validationSchema = yup.object({
  ...
  duca_No_Duca: yup.string().required('El No. DUCA es requerida'),
...
const PedidoOrdenCreateComponent = ({ onCancelar, onGuardadoExitoso }) => {
  ...
  const formik = useFormik({
        ...
        onSubmit: (values) => {
          ...
          const datosParaEnviar = {
            peor_Codigo: values.peor_Codigo,
            prov_Id: values.prov_Id,
            duca_No_Duca: values.duca_No_Duca,
            ciud_Id: values.ciud_Id,
            peor_DireccionExacta: values.peor_DireccionExacta,
            peor_FechaEntrada: values.peor_FechaEntrada,
            peor_Obsevaciones: values.peor_Obsevaciones,
            peor_Impuestos: values.peor_Impuestos,
          ...
          axios.post(`${apiUrl}/api/PedidosOrden/Insertar`, datosParaEnviar, {
          ...
          .catch(error => {
            console.error("Error al insertar el pedido de orden:", error);
...
export default PedidoOrdenCreateComponent;