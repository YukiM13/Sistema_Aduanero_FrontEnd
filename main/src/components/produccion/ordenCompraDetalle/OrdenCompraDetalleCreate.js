...
//                     >
//                       {estilos.map((estilo) => (
//                       <MenuItem key={estilos.esti_Id} value={estilos.esti_Id}>
...
//                     >
//                       {colores.map((color) => (
//                     <MenuItem key={colores.esti_Id} value={colores.esti_Id}>
//                       {colores.colr_Nombre}
//                     </MenuItem>
//                   ))}
//                     </CustomTextField>                      
...
//                 >
//                   {procesosActuales.map((procesoActual) => (
//                     <MenuItem key={procesosActuales.proc_IdComienza} value={procesosActuales.proc_IdComienza}>
//                       {procesosActuales.proc_DescripcionComienza}
//                     </MenuItem>
//                   ))}
//                 </CustomTextField>
...
const OrdenCompraDetallesCreateComponent = ({ onCancelar, onGuardadoExitoso }) => {
  const { id: ordenCompraID } = useParams();
  const [ordenCompraDetalles, setOrdenCompraDetalle] = useState([]);
  const [procesosActuales, setProcesosActuales] = useState([]);
  const [estilos, setEstilos] = useState([]);
  const [colores, setColores] = useState([]);
