...
const ProveedoresEditComponent = ({proveedor, onCancelar, onGuardadoExitoso }) => { //esto es lo que manda para saber cuando cerrar el crear
...
const [openSnackbar, setOpenSnackbar] = useState(false); 
  ...
  const formik = useFormik({
        ...
        validationSchema,
        onSubmit: (values) => {
          values.prov_FechaModificacion = new Date();
          values.usua_UsuarioModificacion = 1;
          console.log("Valores antes de enviar:", values);
          axios.post(`${apiUrl}/api/Proveedores/Editar`, values, {
...
export default ProveedoresEditComponent;
