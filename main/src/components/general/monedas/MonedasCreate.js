...
import Moneda from 'src/models/monedaModel';
...
const MonedaCreateComponent = ({ onCancelar, onGuardadoExitoso }) => { //esto es lo que manda para saber cuando cerrar el crear
const [openSnackbar, setOpenSnackbar] = useState(false); 
  ...
  const formik = useFormik({
        ...
        onSubmit: (values) => {
          ...
          axios.post(`${apiUrl}/api/Moneda/Insertar`, values, {
...
export default MonedaCreateComponent;
