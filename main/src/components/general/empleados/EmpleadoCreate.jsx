...
import Empleado from 'src/models/empleadosModel';
...
const EmpleadosCreateComponent = ({ onCancelar, onGuardadoExitoso }) => { //esto es lo que manda para saber cuando cerrar el crear
...
const listarProvinciasPorPais = (paisId) => {
  ...
  const formik = useFormik({
        ...
        onSubmit: (values) => {
          ...
          axios.post(`${apiUrl}/api/Empleados/Insertar`, values, {
...
export default EmpleadosCreateComponent;
