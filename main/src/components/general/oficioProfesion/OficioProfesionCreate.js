...
import oficioProfesion from 'src/models/oficioProfesionModel';
...
const OficioCreateComponent = ({ onCancelar, onGuardadoExitoso }) => { //esto es lo que manda para saber cuando cerrar el crear
...
export default OficioCreateComponent;
