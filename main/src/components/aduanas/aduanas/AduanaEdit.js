...
const AduanasEditComponent = ({aduana, onCancelar, onGuardadoExitoso }) => { //esto es lo que manda para saber cuando cerrar el crear
...
const [openSnackbar, setOpenSnackbar] = useState(false); 
  ...
  const formik = useFormik({
        ...
        validationSchema,
        onSubmit: (values) => {
          values.adua_FechaModificacion = new Date();
          values.usua_UsuarioModificacion = user;
          console.log("Valores antes de enviar:", values);
          axios.post(`${apiUrl}/api/Aduanas/Editar`, values, {
...
export default AduanasEditComponent;
