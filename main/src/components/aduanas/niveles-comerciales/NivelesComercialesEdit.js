...
const NivelesComercialesEditComponent = ({nivelcomercial, onCancelar, onGuardadoExitoso }) => { //esto es lo que manda para saber cuando cerrar el crear
const [openSnackbar, setOpenSnackbar] = useState(false); 
  ...
  const formik = useFormik({
        ...
        validationSchema,
        onSubmit: (values) => {
          values.nico_FechaModificacion = new Date();
          values.usua_UsuarioModificacion = 1;
          console.log("Valores antes de enviar:", values);
          axios.post(`${apiUrl}/api/NivelesComerciales/Editar`, values, {
    ...
    <div>
        ...
        <Grid container spacing={3} mb={3}>  {/* Esto es como el div con class row */}
                ...
                <Grid item lg={6} md={12} sm={12}>
                        ...
                        <CustomFormLabel>Descripción del nivel comercial</CustomFormLabel>
                        <CustomTextField
                            fullWidth
                            id="nico_Descripcion"
...
export default NivelesComercialesEditComponent;
